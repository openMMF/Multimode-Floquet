...
fields    = openmmf.mode_c_python*nm  #THIS INSTRUCTION DEFINES A TYPE OF ARRAY OF modes WITH nm COMPONENTS

#fields_test    = openmmf.mode_c_T()
fields_test    = openmmf.mode_c_python(d_bare)
#%%
#field     = fields()            # THIS INSTANCE DECLARES THE FIELDS
field     = fields(d_bare=8)  # THIS INSTANCE DECLARES THE FIELDS
#%%
...
openmmf.coupling_init(field,nm,d_bare,info)
...
for m in range(N_):
    ...
    h_floquet_size = openmmf.multimodefloquetmatrix(id,modes_num,info)
