SUBROUTINE DRESSEDBASIS_C(D,ID,NM,MODES_NUM,U_FD,E_DRESSED,INFO)
...
SUBROUTINE DRESSEDBASIS_SUBSET_C(ID,DRESSINGFLOQUETDIMENSION,DRESSINGFIELDS,&
        & NM,DRESSINGFIELDS_INDICES,MODES_NUM,U_FD,E_DRESSED,INFO)
...
!!$ INFO (INOUT)                 : INFO = 0 MEANS SUCESS
  ...
  !write(*,*) "DBS",dressingfields_indices_,dressingfields_indices,dressingfields
  !write(*,*) "DBS",modes_num
  CALL DRESSEDBASIS_SUBSET(ATOM_,DRESSINGFLOQUETDIMENSION,DRESSINGFIELDS,&
