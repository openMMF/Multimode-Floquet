SUBROUTINE MULTIMODEFLOQUETMATRIX_C(ATOM__C,NM,NF,MODES_NUM,INFO)
...
! the following function is defined for the python interface
...
SUBROUTINE GET_H_FLOQUET_C(h_floquet_size_,H_FLOQUET_C_,INFO)
 ...
 ! write(*,*) h_floquet,info
  IF(INFO.EQ.-1) THEN ! THIS MEANS WE SHOULD USE AN EXTERNAL TOOL TO DIAGONALIZSE THE HAMILTONIAN because I am killing the Floquet matrix
