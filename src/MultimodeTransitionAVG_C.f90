SUBROUTINE MULTIMODETRANSITIONAVG_C(D,NM,FIELD,MODES_NUM,U_F_MODES,E_MULTIFLOQUET,D_BARE,U,INFO) 
...
!!$  INFO           (INOUT): (POSSIBLE) ERROR FLAG
  ...
  IMPLICIT NONE
  TYPE(MODE_C),DIMENSION(NM), INTENT(IN)     :: FIELD
  ...
  DOUBLE PRECISION, DIMENSION(D_BARE,D_BARE), INTENT(OUT)   :: U           ! TIME AVERAGE TRANSITION MATRIX 
  
  CALL MULTIMODETRANSITIONAVG(D,NM,COUPLING,MODES_NUM,U_F_MODES,E_MULTIFLOQUET,D_BARE,U,INFO) 
  
END SUBROUTINE MULTIMODETRANSITIONAVG_C
