...
for m in range(N_):
    ...
    values,row_index,column = openmmf.get_h_floquet_sp(h_floquet_size,info)
    print(h_floquet_size)
    print(values)
    print(row_index)
    print(column)
#    
...
#    #openmmf.mklsparse_fulleigenvalues(h_floquet_size,U_F,e_floquet,e_l,e_r,info)
#    #print(e_floquet)
#
